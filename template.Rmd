...
Covariates considered in the full model included \emph{year, depth, month or 2-month wave} and, \emph{region} (Figures \ref{fig:prehist_onboard_summary and \ref{fig:prehist_onboard_CPAH}).
...
```{r, eval=TRUE, echo=FALSE, results='asis', message=FALSE}
          #onboard filter table
             Onboard_filter.table = xtable(Onboard_filter,caption=c("Onboard observer dataset filtering criteria and resutling sample sizes 
                                                                    used for China rockfish."),label='tab:Onnboard_filter',digits=0)
