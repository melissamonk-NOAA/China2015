...
![Phase plot of estimated relative (1-SPR) vs. relative spawning biomass for the three base case models. The relative (1-SPR) is (1-SPR) divided by 30\% (the SPR target). Relative depletion is the annual spawning biomass divided by the spawning biomass corresponding to 25\% of the unfished spawning biomass. The red point indicates 2014. \label{fig:phase_all}](r4ss/plots_compare/base_compare13_phase_plot.png)
...
#  create the Spawning biomass table
  base_summary.table = xtable(base_summary, caption=c("China rockfish North? base case results summary."), 
    ...
    print(base_summary.table, include.rownames=FALSE, caption.placement="top",floating.environment="sidewaystable",
           scalebox=.8,align=TRUE, hline.after=c(-1,0,7,9,11,nrow(base_summary.table)) )
```
