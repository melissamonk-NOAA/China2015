...
```{r, eval=TRUE, echo=FALSE, results='asis', message=FALSE}
  ...
  Recruit.table = xtable(Recruittab, caption=c("Recent recruitmentfor the northern model (Washington state MCAs 1-4 ."),
               label='tab:Recruit_N',digits=0)  #digits=0 rounds the numbers
...
```{r, eval=TRUE, echo=FALSE, results='asis', message=FALSE}
  ...
  Recruit.table = xtable(Recruittab, caption=c("Recent recruitment for the central ($40^\\circ 10^\\prime$ N. lat. to the OR/WA border) model."),
               label='tab:Recruit_C',digits=0)  #digits=0 rounds the numbers
    #xtable requires a placeholder for rownames, hence 4 values    
    align(Recruit.table) = c('l','l','>{\\centering}p{1in}','>{\\centering}p{1.2in}')  
    print(Recruit.table, include.rownames=FALSE, caption.placement="top",tabular.environment="tabularx",
          width="\\textwidth")
...
```{r, eval=TRUE, echo=FALSE, results='asis', message=FALSE}
  ...
  Recruit.table = xtable(Recruittab, caption=c("Recent recruitment for the southern (south of $40^\\circ 10^\\prime$ N. latitude) model."),
               label='tab:Recruit_S',digits=0)  #digits=0 rounds the numbers
    #xtable requires a placeholder for rownames, hence 4 values    
    align(Recruit.table) = c('l','l','>{\\centering}p{1in}','>{\\centering}p{1.2in}')  
    print(Recruit.table, include.rownames=FALSE, caption.placement="top",tabular.environment="tabularx",
          width="\\textwidth")
...
base_summary = cbind(mngmt,North_summary, Central_summary, South_summary)
 ...
 base_summary$names=c('Comm. landings (mt)','Total Est. Catch (mt)','Nearshore RF ABC/OFL',
                      'China contrib. ABC/OFL', 'Nearshore RF OY/ACL','China contrib. OY/ACL',
                      'Comm. landings (mt)','Total Est. Catch (mt)','Nearshore RF ABC/OFL',
                      'China contrib. ABC/OFL','Nearshore RF OY/ACL','China contrib. OY/ACL'
...
#  create the Spawning biomass table
  base_summary.table = xtable(base_summary, caption=c("China rockfish base case results summary."), 
    ...
    print(base_summary.table, include.rownames=FALSE, caption.placement="top",floating.environment="sidewaystable",sanitize.text.function = function(x){x},
           scalebox=.75,align=TRUE, hline.after=c(-1,0,6,11,21,30,nrow(base_summary.table)) )
```
...
![Equilibrium yield curve for the northern base case model. Values are based on the 2014 fishery selectivity and distribution with steepness fixed at xxxx. \label{fig:yield_N}](r4ss/plots_N/yield1_yield_curve.png)
...
*NMFS groundfish ecology survey*      
The SWFSC Fisheries   Ecology Division conducted longline and bottom trawl surveys from 2001-2005 in Monterey Bay ($36^\circ N to 37.5^\circ N$). A small number of China rockfish length samples were available from this cruise, but were not included in the assessments due to sample size and potential differences in selectivity.

*Miller and Gotshall [-@Miller1965]*      
The Northern California Marine Sport Fish Survey conducted an assessment survey with goals that included estimation of annual fishing effort by all recreational fishing modes, catch by weight, CPUE, and collection of  data to analyze length compositions.  Lengths from 101 China rockfish were collected from 1959-1960. Lengths of chinas from 1959 primarily came from private/rental boats, and lengths from 1960 came from charter boats. These two years of data were not consistent with length composition data from later years, and were influential on model results (see model sensitivities to these data).
...
Jeff Abrams [-@Abrams2014] conducted a research study aboard recreational charter boats from Crescent City Harbor, Trinidad Bay and the Noyo River Harbor.  Rocky habitat was identified from high resolution bathymetric data and gridded into 500 m by 500 m cells (California Seafloor Mapping Project, data available from: http://seafloor.otterlabs.org/index.html).  During a sampling event, cells were randomly selected to fish.  Fish were captured via hook-and-line by either researchers, students, or recreational fishers.  The charter boat captain was not allowed to search and target fish within the cell.  Fishing drifts started at the up-current/wind side of the cell and drifted to the opposite edge of the cell, then stopped the clock and reset for another drift (Jeff Abrams, pers. comm.)  If it was certain that fishing was occurring over sand, the captain's would generally reset. However, because cells were selected with a minimum area of rocky habitat, this was rare.  This studied provided 138 individual China rockfish.
...
![WDFW length compositions for the southern Washington recreational fleet, all modes. \label{fig:N_comp_lendat_flt1mkt0}](r4ss/plots_N/comp_lendat_flt1mkt0.png)

![WDFW length compositions for the northern Washington recreational CPFV fleet. \label{fig:N_comp_lendat_flt3mkt0}](r4ss/plots_N/comp_lendat_flt3mkt0.png)

![WDFW conditional age at length for the recreational fishery in northern Washington. \label{fig:N_comp_condAALdat_bubflt3mkt0}](r4ss/plots_N/comp_condAALdat_bubflt3mkt0.png)
