...
![Equilibrium yield curve for the the base case models. Values are based on the 2014 fishery selectivity and distribution with steepness fixed at xxxx. \label{fig:yield_all}](r4ss/plots_compare/yield_comparison_3_models.png)
