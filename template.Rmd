...
```{r, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
###read in WA dataset
  #WA_dock = read.csv("./txt_files/WAdock.csv")
 
# WA_dock1 = read.csv("./txt_files/CA_MRFSSdock1.csv")
# WA_dock1 = WA_dock[1:18,c(1,2,4)]
 # colnames(WA_dock) = c('Year','Index','Log-scale SE')
```

```{r, eval=TRUE, echo=FALSE, results='asis', message=FALSE}
#WA dockside table
# WA_dock.table = xtable(WA_dock1,caption=c("Year effects for the washington dockside dockside index"),label='tab:WAdock',digits=4)
