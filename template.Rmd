...
There is limited information available on stock structure or life history.  No genetic research has been conducted for China rockfish, and no published research indicates separate stocks along the West Coast.  China rockfish do not appear to exhibit sexual dimorphism [@Lenarz1991].  The oldest aged China rockfish from Alaska was 78 years old [@Munk2001].  Recently aged China rockfish from the West coast had a maximum age of xx years from xx.  Little is known about the maturity scehdule and fecundity of China rockfish.  Echeveria [-@Echeverria1987] collected 69 China rockfish, of which the age at first maturity was 3 years for males and females (26 cm).  Both males and females exhibited 50% maturity at 4 years (27 cm) and 100% maturity at 6 years (30 cm).   

A study by Lea et al. [-@Lea1999] captured females releasing larvae in April and May, and spent females in April, June and October off the coast of California.  One diet study indicated that China rockfish in central California predominantly feed on crustaceans and ophiuroids, while the diets of Chian rockfish in northern California was dominated by crusteaceans and mollusks [@Lea1999].  Echeveria [-@Echeverria1987] identified January - June as the months of parturition for China rockfish in north-central California, wit the peak of repoductive activity in January.


Both juvenile and adult rockfish tend to be solitary and exhibit high site fidelity among rocky habitats. Juvenile China rockfish inhabit rocky areas and can be found in nearshore kelp beds (per comm. \hl{E.J. did you talk with Marc Carr about this}).  An experimental study with captive China rockfish found that juveniles exhibit both site fidelity and territoriality. [@Lee2009].  A tag and recapture study by Lea et al. [-@Lea1999] indicated Chian rockfish have high site fidelity.  While the did not report the exact distance from all China rockfish from the study were recaptured in the same "general locality at which they were released."  In other rockfish movement studies, China rockfish were tagged but never recaptured [@Hanan2012], or there was a sample size of one fish [@Hannah2011].  

An ongoing study in Oregon has tagged and tracked seven China rockfish (personal communication Tom Calvanese, Oregon State University).  The maximum distance traveled by any of these China rockfish is xxxx.
...
Surveys of rockfishes in \emph{Nereocystis} and \emph{Macrocystis} kelp forests observed China rockfish in only the \emph{Macrocystis} kelp forests [@Bodkin1986].
...
###read in WA dataset
  ...
  WA_dock1 = WA_dock[,c(1,2,3)]
 colnames(WA_dock) = c('Year','Index','CV')
```

```{r, eval=TRUE, echo=FALSE, results='asis', message=FALSE}
#WA dockside table
 WA_dock.table = xtable(WA_dock1,caption=c("Year effects for the Washington dockside index"),label='tab:WAdock',digits=4)
...
#WASHINGTON
 ...
 # arrows(WAdock$Year, WAdock$lowerCI, WAdock$Year, WAdock$upperCI, code=3, angle=90,length=0.01)
