...
![Likelihood profile over natrual mortality, $M$, showing changes in negative log-likelihoods by data type for the pre-STAR central model.  \label{fig:C_profile_Mortality.C}](r4ss/plots_profiles/profile_Mortality.C.png)

![Likelihood profile over natrual mortality, $M$, showing changes in negative log-likelihoods by data type for the pre-STAR southern model. \label{fig:S_profile_Mortality.S}](r4ss/plots_profiles/profile_Mortality.S.png)

![Likelihood profile over natrual mortality, $M$, showing changes in negative log-likelihoods by data type for the pre-STAR northern model.  \label{fig:N_profile_Mortality.N}](r4ss/plots_profiles/profile_Mortality.N.png)
