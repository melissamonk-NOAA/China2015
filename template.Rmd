...
##Data and assessment{-}
China rockfish was assessed as a data moderate stock in 2013 using the X-DBSRA modeling framework [@Cope2015].  This assessment uses the newest version of Stock Synthesis (3.24v).  
