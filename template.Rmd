...
```{r, eval=TRUE, echo=FALSE, results='asis', message=FALSE}
     ...
     print(decision_central.table,add.to.row=addtorow, include.rownames=FALSE, caption.placement="top",
         hline.after=c(-1,0,10,20,30,nrow(decision_central.table)),scalebox=.9)
...
##Response to the 2015 STAR Panel Recommendations
\begin{description}[style=unboxed]
...
\item[Request No. 2: Add the current assessment biomass trends for current base model to the plot in the draft assessment that compares the XDB-SRA and SS3 runs and plot an additional set of runs for all models where steepness and natural mortality are estimated with priors (add results from the northern and central models).  This would be two sets of plots with spawning biomass and depletion (all models).] \hfill \\
    ...
    \textbf{STAT Response:} The plots were provided (Figures \ref{fig:STARrequest_S} and \ref{fig:STARrequest_CN}).  Since XDB-SRA 
...
<!-- ******************************************************************************************************************************************** --> 
![Comparison of depletion among the 2013 data moderate assessment, an SS3 bridge model, and the 2015 base case for the combined nothern and central models.   \label{fig:STARrequest2_CN}](plots/STARrequest2_CN.png)

![Comparison of depletion among the 2013 data moderate assessment, an SS3 bridge model, and the 2015 base case for the southern model.   \label{fig:STARrequest2_S}](plots/STARrequest2_S.png)
