...
![Equilibrium yield curve for the base case model. Values are based on the 2014 fishery selectivity and distribution with steepness fixed at xxxx. \label{fig:yield}](r4ss/plots/yield1_yield_curve.png)
...
```{r, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
      ##read in data for 4 tables
        ...
        colnames(MRFSS_N_sample_size) = c('Year', 'Northern CA (Humboldt & Del Norte)','Southern Oregon','Northern Oregon')
...
```{r, eval=TRUE, echo=FALSE, results='asis', message=FALSE}
        ...
        print(MRFSS_N_filter.table, include.rownames=FALSE, caption.placement="top",tabular.environment="tabularx",width="\\textwidth",
                         sanitize.text.function = function(x){x})
```
\FloatBarrier
```{r, eval=TRUE, echo=FALSE, results='asis', message=FALSE}
        ...
        print(MRFSS_N_sample_size.table, include.rownames=FALSE, caption.placement="top",tabular.environment="tabularx",width="\\textwidth",
                         sanitize.text.function = function(x){x})
```
\FloatBarrier
```{r, eval=TRUE, echo=FALSE, results='asis', message=FALSE}
