...
##Data and assessment{-}
China rockfish was assessed as a data moderate stock in 2013 using the X-DBSRA modeling framework [@Cope2015].  This assessment uses the newest version of Stock Synthesis (3.24u).  
...
##Reference points{-}
The management line for China rockfish is at $40^\circ 10^\prime$, with differing management guidelines north and south.  From 2005-2010, the Minor Nearshore Rockfish Complex was managed by a total catch Optimum Yield (OY).  As of the PFMC 2011-12 management cycle, China rockfish has a component OFL and ACL within the Minor Neashore Rockfish Complex, based on the work by Dick and MacCall [-@Dick2010].
...
China rockfish are most commonly captured by hook and line or traps.  They are rarely encountered in the trawl fishery due to the elusive behavior and affinity for rocky crevices.  Their high site fidelity and territoriality lend to the evasivenes of the species.  
...
China rockfish are managed within the Minor nearshore Rockfish Somplex
...
**California MRFSS Dockside Charter Boat Index, Sotuh of $40^\circ 10^\prime$**
...
```{r, eval=TRUE, echo=FALSE, results='asis', message=FALSE}
     ### PRINT SAMPLE SIZE TABLE
                age_length_sample.table = xtable(age_length_sample, caption=c("Samples sizes of available length at age data by region and fleet."),
...
<!-- ******************************************************************************************************************************************** --> 
<!-- ****************************************************aging precicion and bias TABLES*********************************************************--> 
<!-- ******************************************************************************************************************************************** --> 
...
<!-- MRFSS S--> 
![Species coefficients from the binomial GLM for presence/absence of China rockfish in the southern California MRFSS data set. Horizontal bars are 95\% confidence intervals. Albacore coefficient (<-10) excluded for scale.  \label{fig:MRFSS_S_SM}](plots/MRFSS_S_SM.png)


![Diagnostic plots for the China rockfish delta-GLM index (lognormal component) for the southern California MRFSS data set.  These are used to evaluate model fit (top left), assumptions of normality (top right), assumptions of constant variance (bottom left), and the presence of outliers (bottom right). \label{fig:MRFSS_S_diag}](plots/MRFSS_S_diag.png)

```{r,eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE,fig.cap="Index for the northern Califronia MRFSS dockside program, with 95% lognormal confidence intervals. \\label{fig:MRFSS_S_index}"}
#ca
