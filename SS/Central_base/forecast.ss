...
#C  2017 and beyond based on SPR-50%, 40-10, and P*=0.45 for category 2 assessment
#
...
22 # Number of forecast catch levels to input (else calc catch from forecast F)
...
# equal to the 2015/16 ACL contributions from John DeVore which are 6.6mt and 6.8mt
