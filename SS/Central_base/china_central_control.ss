...
#0.01    0.15    0.053    -2.94   3       0.53     -3      0       0       0       0       0       0       0       #       NatM_p_1_Fem_GP_1 (with prior from Owen)
#0.01    0.15    0.06    0.06    -1      0.8      3      0       0       0       0       0       0       0       #       NatM_p_1_Fem_GP_1 - no prior
-10     45        2      2      -1       10      -2      0       0       0       0       0       0       0       #       L_at_Amin_Fem_GP_1
20      50      34      34      -1       10       6      0       0       0       0       0       0       0       #       L_at_Amax_Fem_GP_1
0.01    0.3     0.1     0.1     -1       0.8      6      0       0       0       0       0       0       0       #       VonBert_K_Fem_GP_1
...
0        0        1        1 # 6_OR_SouthernOR_Comm_Live # no extra_se because hit lower bound
...
#_LO HI INIT PRIOR PR_type SD PHASE
0    2  0.5  1     -1      99 2 # extra sd index for fleet 6 # was hitting lower bound
#0    2  0.5  1     -1      99 2 # extra sd index for fleet 7 # index removed
...
15        0       0    5      # 9_OR_NorthernOR_Comm (no comp, mirroring SouthernOR_Comm_Dead)
24        0       0    0      # 10_OR_NorthernOR_Rec_PC
15        0       0   10      # 11_OR_NorthernOR_Rec_PR (no comp, mirroring Rec_PC)
15        0       0    7      # 15_OR_SouthernOR_Rec_PC_index (should always match fleet 7)
#
#_age_selex_types
...
-9      9       8       5       -1      50      -9      0       0       0       0       0       0       0 # FINAL (logistic)
# Fleet group 3
19      45      39.9    30      -1      50      -4      0       0       0       0       0       0       0 # PEAK
-9      5       -4      -4      -1      50      -9      0       0       0       0       0       0       0 # TOP (logistic)
0       9       3       4       -1      50      5       0       0       0       0       0       0       0 # Asc WIDTH exp
0       9       8       8       -1      50      -9      0       0       0       0       0       0       0 # Desc WIDTH exp
-9      9       -8      -5      -1      50      -9      0       0       0       0       0       0       0 # INIT (logistic)
...
#  .72  .28  .22  .11  .066  .027 .052  .046  1     .094   .123   1 #_mult_by_lencomp_N
  0.68 0.33 0.25 0.12 0.09  0.04 0.06  0.04  1     0.13   0.15   1 #_mult_by_lencomp_N
  1    1    1    1    .259  1    .428  1     1     .470   1      1 #_mult_by_agecomp_N
