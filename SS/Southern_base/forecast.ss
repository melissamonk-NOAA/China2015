...
10 # Number of forecast catch levels to input (else calc catch from forecast F) 
...
# Input fixed catch values
 #Year Seas Fleet Catch                        fleet
  2015    1     1  0.446333 		# 1_CA_SouthOf4010_Comm_Dead
  2015    1     2  0.944665333 		# 2_CA_SouthOf4010_Comm_Live
  2015    1     3  5.00433 		# 3_CA_SouthOf4010_Rec_PC
  2015    1     4  5.259993333 		# 4_CA_SouthOf4010_Rec_PR
  2015    1     5  1.455 		# 5_CA_SouthOf4010_Comm_Discard (THIS IS DEAD DISCARD)
  2016    1     1  0.446333 		# 1_CA_SouthOf4010_Comm_Dead
  2016    1     2  0.944665333 		# 2_CA_SouthOf4010_Comm_Live
  2016    1     3  5.00433 		# 3_CA_SouthOf4010_Rec_PC
  2016    1     4  5.259993333 		# 4_CA_SouthOf4010_Rec_PR
  2016    1     5  1.455 		# 5_CA_SouthOf4010_Comm_Discard (THIS IS DEAD DISCARD)
#
